...
but the macros are slightly too permissive for our case.\footnotemark
\footnotetext{
...
A wide range of IMA policies exist, such as appraising all files owned by a particular user or appraising any executed file.
By leveraging various options, it should be possible to cover any desired subset of the filesystem
