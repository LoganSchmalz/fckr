...
Fedora comes out of the box with EVM HMAC support enabled.
We found that disabling EVM HMAC support prevents Fedora from booting due to its reliance on some dynamically-modified files.
